/*
**************************************************
This Code belongs to https://github.com/AbdullahDiaa/garabic#Apache-2.0-1-ov-file with the Apache2.0-License
The reason I copied it into a separate file is to stop the program from printing the word everytime I shape it
**************************************************
*/
...
func ShapeArabic(input string) string {
